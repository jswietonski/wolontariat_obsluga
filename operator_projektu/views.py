...
from .serializers import OperatorProjektuSerializer , KategoriaSerializer, InicjatywaSerializer, UzytkownikSerializer, UczestnikSerializer
...
def update_participant(request, pk):
    item = Uczestnik.objects.get(pk=pk)
